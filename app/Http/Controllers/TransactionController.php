...
//     $transactions = Transaction::with(['user', 'member', 'detail.product'])->get();

//     // Pilih view berdasarkan role
//     if ($user->role == 'admin') {
//         $view = 'transactions.staff.index';
...
//     return view($view, compact('transactions', 'user'));
// }
...
public function index(Request $request)
{
    ...
    return view('transactions.admin.index', compact('transactions', 'user'));
}
...
//     return view('transactions.admin.index', compact('transactions', 'search', 'entries', 'user', 'year', 'month', 'date'));
// }
    ...
    public function receiption($id, Request $request)
{
    ...
    // {
    //     return Excel::download(new TransactionsExport, 'report-purchases.xlsx');
    // }
