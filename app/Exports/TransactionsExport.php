...
class TransactionsExport implements FromCollection, WithHeadings
{
    ...
    // {
    //     $transactions = Transaction::with(['detail.product', 'member'])
    ...
    //         $customerName = $trx->member ? $trx->member->name : 'Non Member';
    //         $phoneNumber = $trx->member ? $trx->member->no_phone : '-';
    //         $point = $trx->member ? $trx->member->point : '-';
    ...
    //         $discountPoint = 0;
    //         if ($trx->member && $trx->member->point > 0 && $totalPrice > $totalPayment) {
    //             $discountPoint = $totalPrice - $totalPayment - $change;
    //         }

    //         $exportData[] = [
    //             'Name Member' => $customerName,
    //             'No HP Member' => $phoneNumber,
    //             'Point Member' => $point,
    //             'Product' => $products,
    //             'Total Price' => 'Rp. ' . number_format($totalPrice, 0, ',', '.'),
    //             'Total Payment' => 'Rp. ' . number_format($totalPayment, 0, ',', '.'),
    //             'Total Discount Point' => 'Rp. ' . number_format($discountPoint, 0, ',', '.'),
    //             'Change' => 'Rp. ' . number_format($change, 0, ',', '.'),
    //             'Date Purchase' => $trx->created_at->format('d-m-Y'),
    //         ];
    //     }
