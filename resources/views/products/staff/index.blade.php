...
@section('content')
    ...
    <main class="flex-1 p10 ml-4">
        ...
        <!-- Search Form -->
        <form method="GET" action="{{ route('products2.index2') }}" class="mt-3 mb-6 flex items-center space-x-4">
            <input type="text" name="search" placeholder="Sea rch by product name..." value="{{ request()->get('search') }}" class="px-4 py-2 border border-gray-300 rounded-md" />
            <button type="submit" class="px-3 py-2 bg-blue-400 text-white rounded-md hover:bg-blue-700">
