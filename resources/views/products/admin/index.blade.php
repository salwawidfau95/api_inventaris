...
@section('content')
    ...
    <main class="flex-1 p10 ml-4">
        ...
        <!-- Search Form -->
        <form method="GET" action="{{ route('products.index') }}" class="mt-3 mb-6 flex items-center space-x-4">
            <input type="text" name="search" placeholder="Search by product name..." value="{{ request()->get('search') }}" class="px-4 py-2 border border-gray-300 rounded-md" />
